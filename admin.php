...
function ourprofiles_admin_menu() {
    $plugin_hook_name = add_menu_page( __('Profile Pages'), __('Profile Pages'), 'manage_options', 'our-profiles-config', 'ourprofiles_config_page',plugins_url() . '/our-profiles/images/favicon.png' );
